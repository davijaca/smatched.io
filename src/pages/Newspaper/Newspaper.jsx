            ...
            <div className={styles.topFirst}>
                ...
                <div className={styles.leftMain}>
                    <div className={styles.leftImgInfo}>
                        <img className={styles.leftImg} src="./iPadMini.png" alt='An iPad with our work'/>
                    </div>
                </div>
                </div>
            </div>
                ...
                <div>
                    <div className={styles.mobileTopFirstBg}>
                        ...
                        <div className={styles.leftMainMobile}>
                            ...
                            <img className={styles.leftImgMobile} src="./iPadMini.png" alt='An iPhone with an offerwall'/>
                            </div>
                        </div>
                ...
                <div>
                    <div className={styles.mobileTopThirdBg}>
                        ...
                        <div className={styles.leftMainMobile3}>
                            ...
                            <img className={styles.leftImgMobile3} src="./Groupthird.png" alt='An iPhone with an offerwall'/>
                            </div>
                        </div>
